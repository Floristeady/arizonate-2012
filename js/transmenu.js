...
//==================================================================================================
TransMenu.spacerGif = "/img/none.gif";                   // path to a transparent spacer gif
...
TransMenu.menuPadding = 4;                             // padding between menu border and items grid
TransMenu.itemPadding = 0;                             // additional padding around each item
TransMenu.shadowSize = 2;                              // size of shadow under menu
TransMenu.shadowOffset = 3;                            // distance shadow should be offset from leading edge
TransMenu.shadowColor = "#5c2122";                        // color of shadow (transparency is set in CSS)
TransMenu.shadowPng = "/img/grey-40.png";               // a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#df5043";                   // color of the background (transparency set in CSS)
