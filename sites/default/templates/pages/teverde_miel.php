...
<?php include("partials/nav_2_teverde.php"); ?>
...
<div id="fondo_flash">
  ...
  <object id="FlashID2" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="866" height="450">
        	  <param name="movie" value="/flash/fondo_teverde.swf" />
        	  ...
        	  <!--[if !IE]>-->
        	  <object type="application/x-shockwave-flash" data="/flash/fondo_teverde.swf" width="866" height="450">
        	    <!--<![endif]-->
        	    <param name="quality" value="high" />
        	    <param name="wmode" value="transparent" />
        	    <param name="swfversion" value="9.0.45.0" />
...
<div class="col_IZ">
    ...
    <div class="modulo_texto01">
    	<p>Una bebida única, deliciosa y refrescante.</p> 
...
<p>Agua filtrada, almíbar de maíz alto en fructosa, miel, ácido cítrico, ácido ascórbico, extracto de limón, extracto de ginseng (10 mg/100 ml). </p>
<p>Duración 18 meses.
</p>
    </div>
    <!--/modulo_ingredientes-->
