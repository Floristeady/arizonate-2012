...
<div id="back" class="back_tedietfram">
...
<div class="col_DE">
    ...
    <!--titulos-->
	<div class="titulo_tedietfram">
		<h1>Té negro DIET</h1>
		<h6>sabor frambuesa</h6>
	</div>
    <!--/titulos-->
     ...
     <div class="subcol_IZ">
	    ...
	    <div id="product" class="modulo_botella_3">
	    	<img src="/img/products/botella_06.png" />
	    </div>
	    <!--/modulo_botella-->
    ...
    <div class="subcol_DE">
			...
			<div class="modulo_datos">
		 		<div class="cuadro05"></div>
				<?php include("partials/tabla_5.php"); ?>
		    </div><!--modulo_tabla-->
