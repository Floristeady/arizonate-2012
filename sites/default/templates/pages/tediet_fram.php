...
<div class="col_DE">
    ...
    <!--titulos-->
	<div class="titulo_tearandano"></div>
    <!--/titulos-->
     ...
     <div class="subcol_IZ">
	    ...
	    <img src="/img/test/botella_06.png" />
	    </div>
	    <!--/modulo_botella-->
    ...
    <div class="subcol_DE">
		    ...
		    <div class="modulo_ingredientes">
				...
				<p> Agua filtrada, extracto natural de ar&aacute;ndano, sorbitol, ácido c&iacute;trico, extracto de zanahoria, sucralosa (0.48 mg/porción-0.2 mg/100ml), acesulfame de potasio (0.24 mg/porción-0.1mg/100 ml). </p>
