...
<div id="fondo_flash">
  <object id="FlashID2" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="866" height="450">
    <param name="movie" value="/flash/fondo_tediet.swf" />
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="/flash/fondo_tediet.swf" width="866" height="450">
      <!--<![endif]-->
      <param name="quality" value="high" />
      <param name="wmode" value="transparent" />
      <param name="swfversion" value="9.0.45.0" />
...
<div class="col_IZ">
    ...
    <!--titulos-->
	<div class="titulo_tediet"></div>
    <!--/titulos-->
    
    <!--modulo_botella-->
    <div class="modulo_botella">
    	<img src="/img/test/botella_04.png" />	
    </div>
    <!--/modulo_botella-->
