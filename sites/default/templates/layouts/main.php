...
<ul id="nav-primary">
	...
	<li><a class="te <? if (substr(get_current_action(), 0, 6) == "teverd" || substr(get_current_action(), 0, 6) == "tediet" || substr(get_current_action(), 0, 6) == "teblan" || substr(get_current_action(), 0, 6) == "tehela") {?>_ON<? } ?>" href="<?=url_for("main", "teverde_miel")?>">Té Arizona</a>
		<ul class="subnav">
		    ...
		    <li><a href="<?=url_for("main", "tediet_arandano")?>">Té verde Diet sabor Arándano </a></li>
		    <li><a href="<?=url_for("main", "tediet_durazno")?>">Té helado Diet sabor Durazno </a></li>   
	...
	<li><a class="nectar <? if (substr(get_current_action(), 0, 6) == "nectar" ) {?>_ON<? } ?>"  href="<?=url_for("main", "tehelado_fram")?>">Jugos</a>
		<ul class="subnav">
			...
			<li><a href="<?=url_for("main", "nectar_kiwi")?>">Néctar sabor Kiwi Frutilla</a></li> 
		</ul>   
	</li> 
...
<footer id="master-footer">	
	...
	<div class="wrapper-a">
		...
		<div class="column">
			...
			<p>Teléfonos: +56 2 222 437 23 | +56 2 222 966 53 | +56 9 7336 7940</p>  
