...
the leading or trailing "/" characters. If you use the Builder app, it will
automatically choose the shortest URI for your files.
...
In (X)HTML files, don't forget to replace any "&" characters with "&amp;". If
you copy from the Builder app's HTML output, this is already taken care of.
...
If you set $min_errorLogger to true, Minify will log some errors to FirePHP (in 
Firefox). Use this temporarily if you're having trouble specifying files.
