...
// (The supported format depends on action your PHP installation supports)
...
// action format should be used for the timing string?
...
// action group should the cached file belong to
...
// action permissions should the cached file have
