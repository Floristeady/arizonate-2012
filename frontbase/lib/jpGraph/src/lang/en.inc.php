...
25009 => array('You must specify action scale to use with a call to Graph::SetScale()',0),
...
25031 => array('You must specify action scale to use with a call to Graph::SetScale().',0),
...
22017 => array('Windrose data contains a direction which is not enabled. Please adjust action labels are displayed.',0),
